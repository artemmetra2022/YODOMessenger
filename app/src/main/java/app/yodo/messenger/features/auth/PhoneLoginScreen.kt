    ...
    Column(
        ...
        if (false) {
            OutlinedTextField(
                ...
                label = { Text(stringResource(R.string.phone_login_label)) },
            ...
            Button(
                ...
                if (uiState is PhoneAuthUiState.SendingCode) {
                    ...
                    Text(stringResource(R.string.phone_login_get_code))
                }
            }
        } else {
            Text(text = stringResource(R.string.phone_login_code_sent, phone), modifier = Modifier.padding(top = 16.dp))

            OutlinedTextField(
                value = code,
                onValueChange = { code = it.take(6) },
                label = { Text(stringResource(R.string.phone_login_sms_label)) },
            ...
            Button(
                ...
                if (uiState is PhoneAuthUiState.VerifyingCode) {
                    ...
                    Text(stringResource(R.string.phone_login_confirm))
                }
            }
            ...
            TextButton(
                ...
                Text(stringResource(R.string.phone_login_resend))
            }
        }
        ...
        TextButton(
            ...
            Text(stringResource(R.string.phone_login_use_email))
        }
    }
}
