 ...
 *  1) ввод облачного пароля;
 *  2) ввод 6-значного кода, отправленного на почту, к которой привязан аккаунт.
 * Пропускает пользователя в приложение только после успешного прохождения обоих шагов.
 */
@Composable
