...
enum class GlobalAdminActionType(val label: String) {
    ...
    // НОВОЕ (причины удаления, автофильтр и история удалённых из «Жалоб»):
    // удаление сообщения с указанием причины, восстановление из архива, правка
    // правил автофильтра, автоудаление по фильтру и очистка архива (30 дней).
