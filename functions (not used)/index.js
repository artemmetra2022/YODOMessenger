...
/**
 * ПРИМЕЧАНИЕ: приветствие в чате поддержки реализовано БЕЗ Cloud Function —
 * см. ChatRepositoryImpl.getOrCreateSupportChat() на клиенте. Это сделано, чтобы
 * не требовать платный план Blaze (Cloud Functions недоступны на бесплатном Spark).
 * Соответствующая логика разрешена в firestore.rules — см. правило create для
 * messages: владелец support-чата может один раз создать сообщение с
 * senderId == "support_system" и фиксированным id документа "support_welcome".
 */
